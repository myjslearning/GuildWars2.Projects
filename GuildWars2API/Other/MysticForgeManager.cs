...
namespace GuildWars2API.Other
{
    public static class MysticForgeManager
    {
        public static List<Recipe> ReadMysticForgeRecipes(bool useLocalRecipes = true) {
            try {
                if(useLocalRecipes) {
        ...
        /// <summary>
        /// Used when the local Mystic Forge is updated. This add custom flags to the resource.
        /// 
        /// WARNING: This method does not write to the JSON file. Just set a breakpoint and copy the value of the variable and copy it to the resource file.
        /// Its hard to write to a resource file during run-time.
        /// </summary>
